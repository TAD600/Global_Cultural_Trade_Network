...
3. Doing the followings for each subset:
    ...
    * You’ve added only vertex attributes
...
length(unique(V(re00)$name)) == gorder(re00)  # should be TRUE
is.character(V(re00)$name) 
any(is.na(E(re00)$weight))      # should be FALSE
any(!is.finite(E(re00)$weight)) # should be FALSE
edge_list_r1 <- as_data_frame(re00, what = "edges")
duplicated_rows_r1 <- duplicated(edge_list_r1[, c("from", "to")])
any(duplicated_rows_r1)  # should be FALSE
...
length(unique(V(re01)$name)) == gorder(re01)  # should be TRUE
is.character(V(re01)$name) 
any(is.na(E(re01)$weight))      # should be FALSE
any(!is.finite(E(re01)$weight)) # should be FALSE
...
length(unique(V(re02)$name)) == gorder(re02)  # should be TRUE
is.character(V(re02)$name) 
any(is.na(E(re02)$weight))      # should be FALSE
any(!is.finite(E(re02)$weight)) # should be FALSE
edge_list_r3 <- as_data_frame(re02, what = "edges")
duplicated_rows_r3 <- duplicated(edge_list_r3[, c("from", "to")])
any(duplicated_rows_r3)  # should be FALSE
...
length(unique(V(re03)$name)) == gorder(re03)  # should be TRUE
is.character(V(re03)$name) 
any(is.na(E(re03)$weight))      # should be FALSE
any(!is.finite(E(re03)$weight)) # should be FALSE
...
length(unique(V(re04)$name)) == gorder(re04)  # should be TRUE
is.character(V(re04)$name) 
any(is.na(E(re04)$weight))      # should be FALSE
any(!is.finite(E(re04)$weight)) # should be FALSE
edge_list_r4 <- as_data_frame(re04, what = "edges")
duplicated_rows_r4 <- duplicated(edge_list_r4[, c("from", "to")])
any(duplicated_rows_r4)  # should be FALSE
...
length(unique(V(re05)$name)) == gorder(re05)  # should be TRUE
is.character(V(re05)$name) 
any(is.na(E(re05)$weight))      # should be FALSE
any(!is.finite(E(re05)$weight)) # should be FALSE
edge_list_r5 <- as_data_frame(re05, what = "edges")
duplicated_rows_r5 <- duplicated(edge_list_r5[, c("from", "to")])
any(duplicated_rows_r5)  # should be FALSE
...
length(unique(V(re06)$name)) == gorder(re06)  # should be TRUE
is.character(V(re06)$name) 
any(is.na(E(re06)$weight))      # should be FALSE
any(!is.finite(E(re06)$weight)) # should be FALSE
edge_list_r6 <- as_data_frame(re06, what = "edges")
duplicated_rows_r6 <- duplicated(edge_list_r6[, c("from", "to")])
any(duplicated_rows_r6)  # should be FALSE
...
length(unique(V(re08)$name)) == gorder(re08)  # should be TRUE
is.character(V(re08)$name) 
any(is.na(E(re08)$weight))      # should be FALSE
any(!is.finite(E(re08)$weight)) # should be FALSE
edge_list_r8 <- as_data_frame(re08, what = "edges")
duplicated_rows_r8 <- duplicated(edge_list_r8[, c("from", "to")])
any(duplicated_rows_r8)  # should be FALSE
...
length(unique(V(re09)$name)) == gorder(re09)  # should be TRUE
is.character(V(re09)$name) 
any(is.na(E(re09)$weight))      # should be FALSE
any(!is.finite(E(re09)$weight)) # should be FALSE
...
length(unique(V(re10)$name)) == gorder(re10)  # should be TRUE
is.character(V(re10)$name) 
any(is.na(E(re10)$weight))      # should be FALSE
any(!is.finite(E(re10)$weight)) # should be FALSE
edge_list_r10 <- as_data_frame(re10, what = "edges")
duplicated_rows_r10 <- duplicated(edge_list_r10[, c("from", "to")])
any(duplicated_rows_r10)  # should be FALSE
...
length(unique(V(re11)$name)) == gorder(re11)  # should be TRUE
is.character(V(re11)$name) 
any(is.na(E(re11)$weight))      # should be FALSE
any(!is.finite(E(re11)$weight)) # should be FALSE
edge_list_r11 <- as_data_frame(re11, what = "edges")
duplicated_rows_r11 <- duplicated(edge_list_r11[, c("from", "to")])
any(duplicated_rows_r11)  # should be FALSE
...
length(unique(V(re12)$name)) == gorder(re12)  # should be TRUE
is.character(V(re12)$name) 
any(is.na(E(re12)$weight))      # should be FALSE
any(!is.finite(E(re12)$weight)) # should be FALSE
edge_list_r12 <- as_data_frame(re12, what = "edges")
duplicated_rows_r12 <- duplicated(edge_list_r12[, c("from", "to")])
any(duplicated_rows_r12)  # should be FALSE
...
length(unique(V(re13)$name)) == gorder(re13)  # should be TRUE
is.character(V(re13)$name) 
any(is.na(E(re13)$weight))      # should be FALSE
any(!is.finite(E(re13)$weight)) # should be FALSE
edge_list_r13 <- as_data_frame(re13, what = "edges")
duplicated_rows_r13 <- duplicated(edge_list_r13[, c("from", "to")])
any(duplicated_rows_r13)  # should be FALSE
...
length(unique(V(re14)$name)) == gorder(re14)  # should be TRUE
is.character(V(re14)$name) 
any(is.na(E(re14)$weight))      # should be FALSE
any(!is.finite(E(re14)$weight)) # should be FALSE
edge_list_r14 <- as_data_frame(re14, what = "edges")
duplicated_rows_r14 <- duplicated(edge_list_r14[, c("from", "to")])
any(duplicated_rows_r14)  # should be FALSE
...
length(unique(V(re15)$name)) == gorder(re15)  # should be TRUE
is.character(V(re15)$name) 
any(is.na(E(re15)$weight))      # should be FALSE
any(!is.finite(E(re15)$weight)) # should be FALSE
edge_list_r15 <- as_data_frame(re15, what = "edges")
duplicated_rows_r15 <- duplicated(edge_list_r15[, c("from", "to")])
any(duplicated_rows_r15)  # should be FALSE
...
length(unique(V(re16)$name)) == gorder(re16)  # should be TRUE
is.character(V(re16)$name) 
any(is.na(E(re16)$weight))      # should be FALSE
any(!is.finite(E(re16)$weight)) # should be FALSE
edge_list_r16 <- as_data_frame(re16, what = "edges")
duplicated_rows_r16 <- duplicated(edge_list_r16[, c("from", "to")])
any(duplicated_rows_r16)  # should be FALSE
...
length(unique(V(re17)$name)) == gorder(re17)  # should be TRUE
is.character(V(re17)$name) 
any(is.na(E(re17)$weight))      # should be FALSE
any(!is.finite(E(re17)$weight)) # should be FALSE
edge_list_r17 <- as_data_frame(re17, what = "edges")
duplicated_rows_r17 <- duplicated(edge_list_r17[, c("from", "to")])
any(duplicated_rows_r17)  # should be FALSE
...
length(unique(V(re18)$name)) == gorder(re18)  # should be TRUE
is.character(V(re18)$name) 
any(is.na(E(re18)$weight))      # should be FALSE
any(!is.finite(E(re18)$weight)) # should be FALSE
edge_list_r18 <- as_data_frame(re18, what = "edges")
duplicated_rows_r18 <- duplicated(edge_list_r18[, c("from", "to")])
any(duplicated_rows_r18)  # should be FALSE
...
length(unique(V(re19)$name)) == gorder(re19)  # should be TRUE
is.character(V(re19)$name) 
any(is.na(E(re19)$weight))      # should be FALSE
any(!is.finite(E(re19)$weight)) # should be FALSE
edge_list_r19 <- as_data_frame(re19, what = "edges")
duplicated_rows_r19 <- duplicated(edge_list_r19[, c("from", "to")])
any(duplicated_rows_r19)  # should be FALSE
...
length(unique(V(re20)$name)) == gorder(re20)  # should be TRUE
is.character(V(re20)$name) 
any(is.na(E(re20)$weight))      # should be FALSE
any(!is.finite(E(re20)$weight)) # should be FALSE
...
length(unique(V(re21)$name)) == gorder(re21)  # should be TRUE
is.character(V(re21)$name) 
any(is.na(E(re21)$weight))      # should be FALSE
any(!is.finite(E(re21)$weight)) # should be FALSE
edge_list_r21 <- as_data_frame(re21, what = "edges")
duplicated_rows_r21 <- duplicated(edge_list_r21[, c("from", "to")])
any(duplicated_rows_r21)  # should be FALSE
...
length(unique(V(re22)$name)) == gorder(re22)  # should be TRUE
is.character(V(re22)$name) 
any(is.na(E(re22)$weight))      # should be FALSE
any(!is.finite(E(re22)$weight)) # should be FALSE
edge_list_r22 <- as_data_frame(re22, what = "edges")
duplicated_rows_r22 <- duplicated(edge_list_r22[, c("from", "to")])
any(duplicated_rows_r22)  # should be FALSE
...
length(unique(V(re23)$name)) == gorder(re23)  # should be TRUE
is.character(V(re23)$name) 
any(is.na(E(re23)$weight))      # should be FALSE
any(!is.finite(E(re23)$weight)) # should be FALSE
edge_list_r23 <- as_data_frame(re23, what = "edges")
duplicated_rows_r23 <- duplicated(edge_list_r23[, c("from", "to")])
any(duplicated_rows_r23)  # should be FALSE
