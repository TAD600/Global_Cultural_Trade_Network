...
length(unique(V(tot00)$name)) == gorder(tot00)  # should be TRUE
is.character(V(tot00)$name) 
any(is.na(E(tot00)$weight))      # should be FALSE
any(!is.finite(E(tot00)$weight)) # should be FALSE
edge_list_t1 <- as_data_frame(tot00, what = "edges")
duplicated_rows_t1 <- duplicated(edge_list_t1[, c("from", "to")])
any(duplicated_rows_t1)  # should be FALSE
...
length(unique(V(tot01)$name)) == gorder(tot01)  # should be TRUE
is.character(V(tot01)$name) 
any(is.na(E(tot01)$weight))      # should be FALSE
any(!is.finite(E(tot01)$weight)) # should be FALSE
edge_list_t2 <- as_data_frame(tot01, what = "edges")
duplicated_rows_t2 <- duplicated(edge_list_t2[, c("from", "to")])
any(duplicated_rows_t2)  # should be FALSE
...
length(unique(V(tot02)$name)) == gorder(tot02)  # should be TRUE
is.character(V(tot02)$name) 
any(is.na(E(tot02)$weight))      # should be FALSE
any(!is.finite(E(tot02)$weight)) # should be FALSE
edge_list_t3 <- as_data_frame(tot02, what = "edges")
duplicated_rows_t3 <- duplicated(edge_list_t3[, c("from", "to")])
any(duplicated_rows_t3)  # should be FALSE
...
length(unique(V(tot03)$name)) == gorder(tot03)  # should be TRUE
is.character(V(tot03)$name) 
any(is.na(E(tot03)$weight))      # should be FALSE
any(!is.finite(E(tot03)$weight)) # should be FALSE
edge_list_t4 <- as_data_frame(tot03, what = "edges")
duplicated_rows_t4 <- duplicated(edge_list_t4[, c("from", "to")])
any(duplicated_rows_t4)  # should be FALSE
...
length(unique(V(tot04)$name)) == gorder(tot04)  # should be TRUE
is.character(V(tot04)$name) 
any(is.na(E(tot04)$weight))      # should be FALSE
any(!is.finite(E(tot04)$weight)) # should be FALSE
edge_list_t5 <- as_data_frame(tot04, what = "edges")
duplicated_rows_t5 <- duplicated(edge_list_t5[, c("from", "to")])
any(duplicated_rows_t5)  # should be FALSE
...
length(unique(V(tot05)$name)) == gorder(tot05)  # should be TRUE
is.character(V(tot05)$name) 
any(is.na(E(tot05)$weight))      # should be FALSE
any(!is.finite(E(tot05)$weight)) # should be FALSE
edge_list_t6 <- as_data_frame(tot05, what = "edges")
duplicated_rows_t6 <- duplicated(edge_list_t6[, c("from", "to")])
any(duplicated_rows_t6)  # should be FALSE
...
length(unique(V(tot06)$name)) == gorder(tot06)  # should be TRUE
is.character(V(tot06)$name) 
any(is.na(E(tot06)$weight))      # should be FALSE
any(!is.finite(E(tot06)$weight)) # should be FALSE
edge_list_t7 <- as_data_frame(tot06, what = "edges")
duplicated_rows_t7 <- duplicated(edge_list_t7[, c("from", "to")])
any(duplicated_rows_t7)  # should be FALSE
...
length(unique(V(tot07)$name)) == gorder(tot07)  # should be TRUE
is.character(V(tot07)$name) 
any(is.na(E(tot07)$weight))      # should be FALSE
any(!is.finite(E(tot07)$weight)) # should be FALSE
edge_list_t8 <- as_data_frame(tot07, what = "edges")
duplicated_rows_t8 <- duplicated(edge_list_t8[, c("from", "to")])
any(duplicated_rows_t8)  # should be FALSE
...
length(unique(V(tot08)$name)) == gorder(tot08)  # should be TRUE
is.character(V(tot08)$name) 
any(is.na(E(tot08)$weight))      # should be FALSE
any(!is.finite(E(tot08)$weight)) # should be FALSE
...
length(unique(V(tot09)$name)) == gorder(tot09)  # should be TRUE
is.character(V(tot09)$name) 
any(is.na(E(tot09)$weight))      # should be FALSE
any(!is.finite(E(tot09)$weight)) # should be FALSE
edge_list_t10 <- as_data_frame(tot09, what = "edges")
duplicated_rows_t10 <- duplicated(edge_list_t10[, c("from", "to")])
any(duplicated_rows_t10)  # should be FALSE
...
length(unique(V(tot12)$name)) == gorder(tot12)  # should be TRUE
is.character(V(tot12)$name) 
any(is.na(E(tot12)$weight))      # should be FALSE
any(!is.finite(E(tot12)$weight)) # should be FALSE
edge_list_t13 <- as_data_frame(tot12, what = "edges")
duplicated_rows_t13 <- duplicated(edge_list_t13[, c("from", "to")])
any(duplicated_rows_t13)  # should be FALSE
...
length(unique(V(tot13)$name)) == gorder(tot13)  # should be TRUE
is.character(V(tot13)$name) 
any(is.na(E(tot13)$weight))      # should be FALSE
any(!is.finite(E(tot13)$weight)) # should be FALSE
edge_list_t14 <- as_data_frame(tot13, what = "edges")
duplicated_rows_t14 <- duplicated(edge_list_t14[, c("from", "to")])
any(duplicated_rows_t14)  # should be FALSE
...
length(unique(V(tot14)$name)) == gorder(tot14)  # should be TRUE
is.character(V(tot14)$name) 
any(is.na(E(tot14)$weight))      # should be FALSE
any(!is.finite(E(tot14)$weight)) # should be FALSE
edge_list_t15 <- as_data_frame(tot14, what = "edges")
duplicated_rows_t15 <- duplicated(edge_list_t15[, c("from", "to")])
any(duplicated_rows_t15)  # should be FALSE
...
length(unique(V(tot15)$name)) == gorder(tot15)  # should be TRUE
is.character(V(tot15)$name) 
any(is.na(E(tot15)$weight))      # should be FALSE
any(!is.finite(E(tot15)$weight)) # should be FALSE
edge_list_t16 <- as_data_frame(tot15, what = "edges")
duplicated_rows_t16 <- duplicated(edge_list_t16[, c("from", "to")])
any(duplicated_rows_t16)  # should be FALSE
...
length(unique(V(tot16)$name)) == gorder(tot16)  # should be TRUE
is.character(V(tot16)$name) 
any(is.na(E(tot16)$weight))      # should be FALSE
any(!is.finite(E(tot16)$weight)) # should be FALSE
edge_list_t17 <- as_data_frame(tot16, what = "edges")
duplicated_rows_t17 <- duplicated(edge_list_t17[, c("from", "to")])
any(duplicated_rows_t17)  # should be FALSE
...
length(unique(V(tot17)$name)) == gorder(tot17)  # should be TRUE
is.character(V(tot17)$name) 
any(is.na(E(tot17)$weight))      # should be FALSE
any(!is.finite(E(tot17)$weight)) # should be FALSE

edge_list_t18 <- as_data_frame(tot17, what = "edges")
duplicated_rows_t18 <- duplicated(edge_list_t18[, c("from", "to")])
any(duplicated_rows_t18)  # should be FALSE
...
length(unique(V(tot18)$name)) == gorder(tot18)  # should be TRUE
is.character(V(tot18)$name) 
any(is.na(E(tot18)$weight))      # should be FALSE
any(!is.finite(E(tot18)$weight)) # should be FALSE
...
length(unique(V(tot19)$name)) == gorder(tot19)  # should be TRUE
is.character(V(tot19)$name) 
any(is.na(E(tot19)$weight))      # should be FALSE
any(!is.finite(E(tot19)$weight)) # should be FALSE
...
length(unique(V(tot20)$name)) == gorder(tot20)  # should be TRUE
is.character(V(tot20)$name) 
any(is.na(E(tot20)$weight))      # should be FALSE
any(!is.finite(E(tot20)$weight)) # should be FALSE

edge_list_t21 <- as_data_frame(tot20, what = "edges")
duplicated_rows_t21 <- duplicated(edge_list_t21[, c("from", "to")])
any(duplicated_rows_t21)  # should be FALSE
...
length(unique(V(tot21)$name)) == gorder(tot21)  # should be TRUE
is.character(V(tot21)$name) 
any(is.na(E(tot21)$weight))      # should be FALSE
any(!is.finite(E(tot21)$weight)) # should be FALSE
...
length(unique(V(tot22)$name)) == gorder(tot22)  # should be TRUE
is.character(V(tot22)$name) 
any(is.na(E(tot22)$weight))      # should be FALSE
any(!is.finite(E(tot22)$weight)) # should be FALSE
...
length(unique(V(tot23)$name)) == gorder(tot23)  # should be TRUE
is.character(V(tot23)$name) 
any(is.na(E(tot23)$weight))      # should be FALSE
any(!is.finite(E(tot23)$weight)) # should be FALSE
