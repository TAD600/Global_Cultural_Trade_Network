...
length(unique(V(un00)$name)) == gorder(un00)  # should be TRUE
is.character(V(un00)$name) 
any(is.na(E(un00)$weight))      # should be FALSE
any(!is.finite(E(un00)$weight)) # should be FALSE
edge_list <- as_data_frame(un00, what = "edges")
duplicated_rows <- duplicated(edge_list[, c("from", "to")])
any(duplicated_rows)  # should be FALSE
...
```{r}
node_names1 <- g1$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un01)$name)) == gorder(un01)  # should be TRUE
is.character(V(un01)$name) 
any(is.na(E(un01)$weight))      # should be FALSE
any(!is.finite(E(un01)$weight)) # should be FALSE
edge_list1 <- as_data_frame(un01, what = "edges")
duplicated_rows1 <- duplicated(edge_list1[, c("from", "to")])
any(duplicated_rows1)  # should be FALSE
...
```{r}
node_names2 <- g2$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un02)$name)) == gorder(un02)  # should be TRUE
is.character(V(un02)$name) 
any(is.na(E(un02)$weight))      # should be FALSE
any(!is.finite(E(un02)$weight)) # should be FALSE
edge_list2 <- as_data_frame(un02, what = "edges")
duplicated_rows2 <- duplicated(edge_list2[, c("from", "to")])
any(duplicated_rows2)  # should be FALSE
...
```{r}
node_names3 <- g3$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un03)$name)) == gorder(un03)  # should be TRUE
is.character(V(un03)$name) 
any(is.na(E(un03)$weight))      # should be FALSE
any(!is.finite(E(un03)$weight)) # should be FALSE
edge_list3 <- as_data_frame(un03, what = "edges")
duplicated_rows3 <- duplicated(edge_list3[, c("from", "to")])
any(duplicated_rows3)  # should be FALSE
...
```
```{r}
node_names4 <- g4$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un04)$name)) == gorder(un04)  # should be TRUE
is.character(V(un04)$name) 
any(is.na(E(un04)$weight))      # should be FALSE
any(!is.finite(E(un04)$weight)) # should be FALSE
edge_list4 <- as_data_frame(un04, what = "edges")
duplicated_rows4 <- duplicated(edge_list4[, c("from", "to")])
any(duplicated_rows4)  # should be FALSE
...
```
```{r}
node_names5 <- g5$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un05)$name)) == gorder(un05)  # should be TRUE
is.character(V(un05)$name) 
any(is.na(E(un05)$weight))      # should be FALSE
any(!is.finite(E(un05)$weight)) # should be FALSE
edge_list5 <- as_data_frame(un05, what = "edges")
duplicated_rows5 <- duplicated(edge_list5[, c("from", "to")])
any(duplicated_rows5)  # should be FALSE
...
```{r}
node_names6 <- g6$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un06)$name)) == gorder(un06)  # should be TRUE
...
any(duplicated_rows6)  # should be FALSE
...
```{r}
node_names7 <- g7$node.attr$iso_o  # or $name, if that’s what you want to use
...
length(unique(V(un07)$name)) == gorder(un07)  # should be TRUE
...
any(duplicated_rows7)  # should be FALSE
...
length(unique(V(un08)$name)) == gorder(un08)  # should be TRUE
...
any(duplicated_rows8)  # should be FALSE
...
length(unique(V(un09)$name)) == gorder(un09)  # should be TRUE
...
any(duplicated_rows9)  # should be FALSE
...
length(unique(V(un10)$name)) == gorder(un10)  # should be TRUE
...
any(duplicated_rows10)  # should be FALSE
...
length(unique(V(un11)$name)) == gorder(un11)  # should be TRUE
...
any(duplicated_rows11)  # should be FALSE
...
length(unique(V(un12)$name)) == gorder(un12)  # should be TRUE
...
any(duplicated_rows12)  # should be FALSE
...
length(unique(V(un13)$name)) == gorder(un13)  # should be TRUE
...
any(duplicated_rows13)  # should be FALSE
...
length(unique(V(un14)$name)) == gorder(un14)  # should be TRUE
...
any(duplicated_rows14)  # should be FALSE
...
length(unique(V(un15)$name)) == gorder(un15)  # should be TRUE
...
any(duplicated_rows15)  # should be FALSE
...
length(unique(V(un16)$name)) == gorder(un16)  # should be TRUE
...
any(duplicated_rows16)  # should be FALSE
...
length(unique(V(un17)$name)) == gorder(un17)  # should be TRUE
...
any(duplicated_rows17)  # should be FALSE
...
length(unique(V(un18)$name)) == gorder(un18)  # should be TRUE
...
any(duplicated_rows18)  # should be FALSE
...
length(unique(V(un19)$name)) == gorder(un19)  # should be TRUE
...
any(duplicated_rows19)  # should be FALSE
...
length(unique(V(un20)$name)) == gorder(un20)  # should be TRUE
...
any(duplicated_rows20)  # should be FALSE
...
length(unique(V(un21)$name)) == gorder(un21)  # should be TRUE
...
any(duplicated_rows21)  # should be FALSE
...
length(unique(V(un22)$name)) == gorder(un22)  # should be TRUE
...
any(duplicated_rows22)  # should be FALSE
...
length(unique(V(un23)$name)) == gorder(un23)  # should be TRUE
...
any(duplicated_rows23)  # should be FALSE
