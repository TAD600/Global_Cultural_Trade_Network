...
`07_residuals.Rmd`: This R markdown file runs three linear regressions (regressing hysteresis effect on trade volume) to find out residuals and adds three residual columns to the `trade.csv` dataset. 
