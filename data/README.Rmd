...
### Description of the csv files in the raw folder:
...
`unique2000_2023.csv`: Created using HS2017 code 97 from the OECD bulk data (BIMTS_HS2017_2D_CSV_1995_To_2023). 
...
`trade.csv`: This long format trade data has three trade volume columns, three hysteresis columns and three residual columns for unique, reproducible and non-cultural trade. 

`unique_edgelist.csv`: This is an edgelist created from `unique2000_2023.csv`.
`reproducible_edgelist.csv`: This is an edgelist created from `reproducible2000_2023.csv`.
