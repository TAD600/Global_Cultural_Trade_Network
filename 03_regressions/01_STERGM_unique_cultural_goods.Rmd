...
# Estimating STERGM
Started: 10 May, 2026 at 2:00PM
Ended: 11 May, 2026 at 1AM (approximately)
```{r}
...
tiff(file = "../results/goftest_unique.tiff",width = 12, height = 3, units = "in", res = 100)
...
V(top)$deg <- strength(top, weights = E(top)$weight)
