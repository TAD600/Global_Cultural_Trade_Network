...
5. Loading the edgelist of unique cultural goods, and making 24 network objects for 24 consecutive years following the steps,     + Keeping only the pairs with positive weights
...
#Hysteresis Effect
I am hashing the following chunk of codes that create a network dynamic object for hysteresis effect of unique cultural goods trade, which takes more than an hour to run. For faster reproducibility, I have saved it in 'results' folder and am loading it from there in the following code block along with 'RTA' network dynamic object. 
```{r}
#hyst_unique <- read.csv("../data/cleaned/edgelist_unique_hyst.csv",stringsAsFactors = FALSE)

#hyst_unique_n0 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n0, "X2000", hyst_unique$X2000)
# 
# #hyst_unique_n1 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n1, "X2001", hyst_unique$X2001)
# 
# #hyst_unique_n2 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n2, "X2002", hyst_unique$X2002)
# 
# #hyst_unique_n3 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n3, "X2003", hyst_unique$X2003)
# 
# #hyst_unique_n4 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n4, "X2004", hyst_unique$X2004)
# 
# #hyst_unique_n5 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n5, "X2005", hyst_unique$X2005)
# 
# #hyst_unique_n6 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n6, "X2006", hyst_unique$X2006)
# 
# #hyst_unique_n7 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n7, "X2007", hyst_unique$X2007)
# 
# #hyst_unique_n8 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n8, "X2008", hyst_unique$X2008)
# 
# #hyst_unique_n9 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n9, "X2009", hyst_unique$X2009)
# 
# #hyst_unique_n10 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n10, "X2010", hyst_unique$X2010)
# 
# #hyst_unique_n11 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n11, "X2011", hyst_unique$X2011)
# 
# #hyst_unique_n12 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n12, "X2012", hyst_unique$X2012)
# 
# hyst_unique_n13 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n13, "X2013", hyst_unique$X2013)
# 
# hyst_unique_n14 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n14, "X2014", hyst_unique$X2014)
# 
# hyst_unique_n15 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n15, "X2015", hyst_unique$X2015)
# 
# hyst_unique_n16 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n16, "X2016", hyst_unique$X2016)
# 
# hyst_unique_n17 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n17, "X2017", hyst_unique$X2017)
# 
# hyst_unique_n18 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n18, "X2018", hyst_unique$X2018)
# 
# hyst_unique_n19 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n19, "X2019", hyst_unique$X2019)
# 
# hyst_unique_n20 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n20, "X2020", hyst_unique$X2020)
# 
# hyst_unique_n21 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n21, "X2021", hyst_unique$X2021)
# 
# hyst_unique_n22 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n22, "X2022", hyst_unique$X2022)
# 
# hyst_unique_n23 <- network(hyst_unique[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_unique_n23, "X2023", hyst_unique$X2023)
# 
# #get.edge.value(hyst_unique_n23, "X2023"))
# class(hyst_unique_n23)

#net_dynamic_hyst_u <- networkDynamic(network.list = list(hyst_unique_n0, hyst_unique_n1, hyst_unique_n2, hyst_unique_n3, hyst_unique_n4, hyst_unique_n5, hyst_unique_n6, hyst_unique_n7, hyst_unique_n8, hyst_unique_n9, hyst_unique_n10, hyst_unique_n11, hyst_unique_n12, hyst_unique_n13, hyst_unique_n14, hyst_unique_n15,hyst_unique_n16 ,hyst_unique_n17, hyst_unique_n18, hyst_unique_n19, hyst_unique_n20, hyst_unique_n21, hyst_unique_n22, hyst_unique_n23),  verbose = TRUE)

#saveRDS(net_dynamic_hyst_u, file = "../results/net_dynamic_hyst_u.rds")

```

```{r}
net_dynamic_rta <- readRDS("../results/net_dynamic_rta.rds")
net_dynamic_hyst_u <- readRDS("../results/net_dynamic_hyst_u.rds")
```


```{r}
class(net_dynamic_hyst_u)
```
...
```{r}
#saveRDS(unique_stgm, "../results/unique_stgm1.rds")
...
```{r}
mcmc.diagnostics(unique_stgm)
```

```{r}
# goftest <- gof(unique_stgm) 
# plot(goftest)
# 
# saveRDS(goftest, "../results/goftest_model1_u.rds")
```

```{r}
goftest <- readRDS("../results/goftest_model1_u.rds")
```
...
tiff(file = "../results/goftest_model1_u.tiff",
...
for (stat in selected_stats) {
  plot(goftest, which = stat, main = "Model 1", cex.lab = 1.5)
}
...
## With Accumulated consumption

Start: 2 August, at 11;06PM
End: 3 August, at 11:57PM
```{r}
#Reference: https://www.rdocumentation.org/packages/ergm/versions/4.8.1/topics/edgecov-ergmTerm
# set.seed(312)
# 
# unique_stgm_hyst <- tergm(list(net_un00, net_un01, net_un02, net_un03, net_un04, net_un05, net_un06, net_un07, net_un08, net_un09, net_un10, net_un11, net_un12, net_un13, net_un14, net_un15, net_un16, net_un17, net_un18, net_un19, net_un20, net_un21, net_un22, net_un23) ~ 
#                                               Form(~nodecov("D_log_gdp_pct") 
#                                                    + absdiff("D_log_gdp_pct")
#                                                    + nodemix("development")
#                                                    + edgecov(net_dynamic_hyst_u)
#                                                    + edgecov(net_dynamic_rta)
#                                                    + nodematch("landlocked")
#                                                    + edgecov(dist_net, "log_dist")
#                                                    + edgecov(contig_mat)
...
```{r}
#saveRDS(unique_stgm_hyst, "../results/unique_stgm2.rds")
unique_stgm_hyst <- readRDS("../results/unique_stgm2.rds")
```

```{r}
print(summary(unique_stgm_hyst))
```

```{r}
pvals_u_h <- summary(unique_stgm_hyst)$coefficients[, "Pr(>|z|)"]
or_u_h <- exp(coef(unique_stgm_hyst))
ste_h <- sqrt(diag(unique_stgm_hyst$covar))
lci_h <- exp(coef(unique_stgm_hyst) - 1.96 * ste_h) 
uci_h <- exp(coef(unique_stgm_hyst) + 1.96 * ste_h)  
oddsratios_h <- cbind(coef(unique_stgm_hyst), round(lci_h, digits = 4), round(or_u_h, digits = 4), round(uci_h, digits = 4), pvals_u_h)
dataframe_u_h =as.data.frame(oddsratios_h)
dataframe_u_h$model_terms <- rownames(dataframe_u_h)
rownames(dataframe_u_h) <- NULL
colnames(dataframe_u_h) <- c('Estimate_u','lCI_u', 'OR_u','uCI_u', 'pvals_u', 'model_terms')
```

```{r}
#write.csv(dataframe_u_h, "../results/unique_stgm2_results.csv")
```
...
```{r}
mcmc.diagnostics(unique_stgm_hyst)
```
Start: 12:12PM 5


Start: 3 August at 9:08PM
End: 3 August at 10:30PM
```{r}
#goftest_hyst <- gof(unique_stgm_hyst)
#plot(goftest_hyst)
#saveRDS(goftest_hyst, "../results/goftest_model2_u.rds")
goftest_hyst <- readRDS("../results/goftest_model2_u.rds")
```


```{r}

# selected_stats_2 <- c("odegree", "idegree", "espart", "distance")
# 
# for (stat in selected_stats_2) {
#   cat("Trying to plot:", stat, "\n")
#   tryCatch({
#     plot(goftest_hyst, which = stat, main = paste("Model 2:", stat))
#   }, error = function(e) {
#     message("Error with stat:", stat)
#     message(e$message)
#   })
# }
# 
...
```{r}
#class(goftest_hyst)
#str(goftest_hyst$obs.odeg)
```

```{r}
#Reference: https://www.datamentor.io/r-programming/saving-plot#:~:text=Save%20as%20tiff%20Image,filename%20%3D%20%22saving_plot3%22)%20.

all_stats_2 <- c("odegree", "idegree", "espartners", "distance", "model")

selected_stats_2 <- all_stats_2[2:5]


tiff(file = "../results/goftest_model2_u.tiff",
     width = 12, height = 3, units = "in", res = 100)
...
for (stat in selected_stats_2) {
  plot(goftest_hyst, which = stat, main = "Model 2", cex.lab = 1.5)
}
