...
#Hysteresis Effect
I am hashing the following chunk of codes that create a network dynamic object for reesidual hysteresis effect of reproducible cultural goods trade, that takes more than an hour to run. For faster reproducibility, I have saved it in 'results' folder and am loading it from there in the following code block along with 'RTA' network dynamic object. 
```{r}
res_r<- read.csv("../data/cleaned/residual_repro.csv",stringsAsFactors = FALSE)

res_r0 <- acast(res_r, iso_o ~ iso_d, value.var = "X2000", fill = 0)
res_r1 <- acast(res_r, iso_o ~ iso_d, value.var = "X2001", fill = 0)
res_r2 <- acast(res_r, iso_o ~ iso_d, value.var = "X2002", fill = 0)
res_r3 <- acast(res_r, iso_o ~ iso_d, value.var = "X2003", fill = 0)
res_r4 <- acast(res_r, iso_o ~ iso_d, value.var = "X2004", fill = 0)
res_r5 <- acast(res_r, iso_o ~ iso_d, value.var = "X2005", fill = 0)
res_r6 <- acast(res_r, iso_o ~ iso_d, value.var = "X2006", fill = 0)
res_r7 <- acast(res_r, iso_o ~ iso_d, value.var = "X2007", fill = 0)
res_r8 <- acast(res_r, iso_o ~ iso_d, value.var = "X2008", fill = 0)
res_r9 <- acast(res_r, iso_o ~ iso_d, value.var = "X2009", fill = 0)
res_r10 <- acast(res_r, iso_o ~ iso_d, value.var = "X2010", fill = 0)
res_r11 <- acast(res_r, iso_o ~ iso_d, value.var = "X2011", fill = 0)
res_r12 <- acast(res_r, iso_o ~ iso_d, value.var = "X2012", fill = 0)
res_r13 <- acast(res_r, iso_o ~ iso_d, value.var = "X2013", fill = 0)
res_r14 <- acast(res_r, iso_o ~ iso_d, value.var = "X2014", fill = 0)
res_r15 <- acast(res_r, iso_o ~ iso_d, value.var = "X2015", fill = 0)
res_r16 <- acast(res_r, iso_o ~ iso_d, value.var = "X2016", fill = 0)
res_r17 <- acast(res_r, iso_o ~ iso_d, value.var = "X2017", fill = 0)
res_r18 <- acast(res_r, iso_o ~ iso_d, value.var = "X2018", fill = 0)
res_r19 <- acast(res_r, iso_o ~ iso_d, value.var = "X2019", fill = 0)
res_r20 <- acast(res_r, iso_o ~ iso_d, value.var = "X2020", fill = 0)
res_r21 <- acast(res_r, iso_o ~ iso_d, value.var = "X2021", fill = 0)
res_r22 <- acast(res_r, iso_o ~ iso_d, value.var = "X2022", fill = 0)
res_r23 <- acast(res_r, iso_o ~ iso_d, value.var = "X2023", fill = 0)

nres_r0 <- as.network(res_r0, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r1 <- as.network(res_r1, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r2 <- as.network(res_r2, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r3 <- as.network(res_r3, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r4 <- as.network(res_r4, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r5 <- as.network(res_r5, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r6 <- as.network(res_r6, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r7 <- as.network(res_r7, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r8 <- as.network(res_r8, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r9 <- as.network(res_r9, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r10 <- as.network(res_r10, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r11 <- as.network(res_r11, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r12 <- as.network(res_r12, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r13 <- as.network(res_r13, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r14 <- as.network(res_r14, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r15 <- as.network(res_r15, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r16 <- as.network(res_r16, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r17 <- as.network(res_r17, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r18 <- as.network(res_r18, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r19 <- as.network(res_r19, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r20 <- as.network(res_r20, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r21 <- as.network(res_r21, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r22 <- as.network(res_r22, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
nres_r23 <- as.network(res_r23, loops = FALSE, directed = TRUE, matrix.type = "adjacency", ignore.eval = FALSE, names.eval = "weight")
```

```{r}
get.edge.attribute(nres_r21, "weight")
```
 

Start: 22/09/2025 on 12:13PM
End: 22/09/2025 on 12:12PM
```{r}
net_dynamic_res_r <- networkDynamic(network.list = list(nres_r0, nres_r1, nres_r2, nres_r3, nres_r4, nres_r5, nres_r6, nres_r7, nres_r8, nres_r9, nres_r10, nres_r11, nres_r12, nres_r13, nres_r14, nres_r15, nres_r16, nres_r17, nres_r18, nres_r19, nres_r20, nres_r21, nres_r22, nres_r23),  verbose = TRUE)
```
...
net_dynamic_res_r <- readRDS("../results/net_dynamic_res_r.rds")
```
...
# plot(goftest_r)
# saveRDS(goftest_r, "../results/goftest_model2_r.rds")
goftest_r <- readRDS("../results/goftest_model2_r.rds")
```
...
tiff(file = "../results/goftest_model2_r.tiff",
...
for (stat in selected_stats_3) {
  plot(goftest_r, which = stat, main = "Model 2", cex.lab = 1.5)
}
