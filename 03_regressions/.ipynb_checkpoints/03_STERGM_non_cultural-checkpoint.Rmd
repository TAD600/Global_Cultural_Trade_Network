...
# hyst_total[, 3:ncol(hyst_total)] <- log(hyst_total[, 3:ncol(hyst_total)] + 1)
# hyst_total_no_loops <- hyst_total[hyst_total$iso_o != hyst_total$iso_d, ]
# 
# hyst_total_n0 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n0, "X2000", hyst_total_no_loops$X2000)
# 
# hyst_total_n1 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n1, "X2001", hyst_total_no_loops$X2001)
# 
# hyst_total_n2 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n2, "X2002", hyst_total_no_loops$X2002)
# 
# hyst_total_n3 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n3, "X2003", hyst_total_no_loops$X2003)
# 
# hyst_total_n4 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n4, "X2004", hyst_total_no_loops$X2004)
# 
# hyst_total_n5 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n5, "X2005", hyst_total_no_loops$X2005)
# 
# hyst_total_n6 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n6, "X2006", hyst_total_no_loops$X2006)
# 
# hyst_total_n7 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n7, "X2007", hyst_total_no_loops$X2007)
# 
# hyst_total_n8 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n8, "X2008", hyst_total_no_loops$X2008)
# 
# hyst_total_n9 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n9, "X2009", hyst_total_no_loops$X2009)
# 
# hyst_total_n10 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n10, "X2010", hyst_total_no_loops$X2010)
# 
# hyst_total_n11 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n11, "X2011", hyst_total_no_loops$X2011)
# 
# hyst_total_n12 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n12, "X2012", hyst_total_no_loops$X2012)
# 
# hyst_total_n13 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n13, "X2013", hyst_total_no_loops$X2013)
# 
# hyst_total_n14 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n14, "X2014", hyst_total_no_loops$X2014)
# 
# hyst_total_n15 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n15, "X2015", hyst_total_no_loops$X2015)
# 
# hyst_total_n16 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n16, "X2016", hyst_total_no_loops$X2016)
# 
# hyst_total_n17 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n17, "X2017", hyst_total_no_loops$X2017)
# 
# hyst_total_n18 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n18, "X2018", hyst_total_no_loops$X2018)
# 
# hyst_total_n19 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n19, "X2019", hyst_total_no_loops$X2019)
# 
# hyst_total_n20 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n20, "X2020", hyst_total_no_loops$X2020)
# 
# hyst_total_n21 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n21, "X2021", hyst_total_no_loops$X2021)
# 
# hyst_total_n22 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n22, "X2022", hyst_total_no_loops$X2022)
# 
# hyst_total_n23 <- network(hyst_total_no_loops[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n23, "X2023", hyst_total_no_loops$X2023)
```

Start: 31/08/2025 on 10:43PM
End: 1/09/2025 on 3:43AM
```{r}
...
```{r}
hyst_resid <- resid(lm(net_dynamic_hyst_t ~ edges)) 
```
...
total_stgm <- tergm(list(net_tot00, net_tot01, net_tot02, net_tot03, net_tot04, net_tot05, net_tot06, net_tot07, net_tot08, net_tot09, net_tot10, net_tot11, net_tot12, net_tot13, net_tot14, net_tot15, net_tot16, net_tot17, net_tot18, net_tot19, net_tot20, net_tot21, net_tot22, net_tot23)~
                                     ...
                                     Persist(~edges + nodecov("D_log_gdp_pct")
                                                    ...
                                                    + edgecov(lang_mat)
                                                    + mutual),
                                                    estimate = "CMLE", times = c(1:24), offset.coef = -2)
