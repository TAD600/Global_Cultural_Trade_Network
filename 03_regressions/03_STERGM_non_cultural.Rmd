...
5. Loading the edgelist of total goods trade, and making 24 network objects for 24 consecutive years following the steps,     + Keeping only the pairs with positive weights
...
#Hysteresis Effect
I am hashing the following chunk of codes that create a network dynamic object for hysteresis effect of total goods trade, which takes about `five` hours to run. For faster reproducibility, I have saved it in 'results' folder and am loading it from there in the following code block along with 'RTA' network dynamic object. 

```{r}
# hyst_total <- read.csv("../data/cleaned/edgelist_total_hyst.csv",stringsAsFactors = FALSE)
# 
# hyst_total_n0 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n0, "X2000", hyst_total$X2000)
# 
# hyst_total_n1 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n1, "X2001", hyst_total$X2001)
# 
# hyst_total_n2 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n2, "X2002", hyst_total$X2002)
# 
# hyst_total_n3 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n3, "X2003", hyst_total$X2003)
# 
# hyst_total_n4 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n4, "X2004", hyst_total$X2004)
# 
# hyst_total_n5 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n5, "X2005", hyst_total$X2005)
# 
# hyst_total_n6 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n6, "X2006", hyst_total$X2006)
# 
# hyst_total_n7 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n7, "X2007", hyst_total$X2007)
# 
# hyst_total_n8 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n8, "X2008", hyst_total$X2008)
# 
# hyst_total_n9 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n9, "X2009", hyst_total$X2009)
# 
# hyst_total_n10 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n10, "X2010", hyst_total$X2010)
# 
# hyst_total_n11 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n11, "X2011", hyst_total$X2011)
# 
# hyst_total_n12 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n12, "X2012", hyst_total$X2012)
# 
# hyst_total_n13 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n13, "X2013", hyst_total$X2013)
# 
# hyst_total_n14 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n14, "X2014", hyst_total$X2014)
# 
# hyst_total_n15 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n15, "X2015", hyst_total$X2015)
# 
# hyst_total_n16 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n16, "X2016", hyst_total$X2016)
# 
# hyst_total_n17 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n17, "X2017", hyst_total$X2017)
# 
# hyst_total_n18 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n18, "X2018", hyst_total$X2018)
# 
# hyst_total_n19 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n19, "X2019", hyst_total$X2019)
# 
# hyst_total_n20 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n20, "X2020", hyst_total$X2020)
# 
# hyst_total_n21 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n21, "X2021", hyst_total$X2021)
# 
# hyst_total_n22 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n22, "X2022", hyst_total$X2022)
# 
# hyst_total_n23 <- network(hyst_total[, c("iso_o", "iso_d")], directed = TRUE, matrix.type = "edgelist", loops = FALSE)
# set.edge.value(hyst_total_n23, "X2023", hyst_total$X2023)
# 
# #get.edge.value(hyst_total_n23, "X2023")
# #class(hyst_total_n23)
# 
# net_dynamic_hyst_t <- networkDynamic(network.list = list(hyst_total_n0, hyst_total_n1, hyst_total_n2, hyst_total_n3, hyst_total_n4, hyst_total_n5, hyst_total_n6, hyst_total_n7, hyst_total_n8, hyst_total_n9, hyst_total_n10, hyst_total_n11, hyst_total_n12, hyst_total_n13, hyst_total_n14, hyst_total_n15, hyst_total_n16, hyst_total_n17, hyst_total_n18, hyst_total_n19, hyst_total_n20, hyst_total_n21, hyst_total_n22, hyst_total_n23),  verbose = TRUE)
# 
# class(net_dynamic_hyst_t)
# 
# saveRDS(net_dynamic_hyst_t, file = "../results/net_dynamic_hyst_t.rds")
```

```{r}
net_dynamic_rta <- readRDS("../results/net_dynamic_rta.rds")
net_dynamic_hyst_t <- readRDS("../results/net_dynamic_hyst_t.rds")
```
...
#saveRDS(total_stgm, "../results/total_stgm5.rds")
```

```{r}
total_stgm <- readRDS("../results/total_stgm5.rds")
```
...
oddsratios2 <- cbind(round(coef(total_stgm)), round(lci2, digits = 4), round(or_t, digits = 4), round(uci2, digits = 4), pvals_t)
...
```{r}
#write.csv(dataframe_t1, "../results/total_stgm5_results.csv")
```
...
# plot(goftest_t)
#saveRDS(goftest_t, "../results/goftest_model5_t.rds")
```

```{r}
goftest_t <- readRDS("../results/goftest_model5_t.rds")
```
...
tiff(file = "../results/goftest_model5_t.tiff",
...
for (stat in selected_stats) {
  plot(goftest_t, which = stat, main = "Model 5", cex.lab = 1.5)
}

dev.off()
```

Start: 12:22PM 5 August, 2025
End:  3:30AM  7 August, 2025
Almost 40 hours
```{r}
# set.seed(321)
# 
# total_stgm_hyst <- tergm(list(net_tot00, net_tot01, net_tot02, net_tot03, net_tot04, net_tot05, net_tot06, net_tot07, net_tot08, net_tot09, net_tot10, net_tot11, net_tot12, net_tot13, net_tot14, net_tot15, net_tot16, net_tot17, net_tot18, net_tot19, net_tot20, net_tot21, net_tot22, net_tot23)~ 
...
```{r}
#summary(total_stgm_hyst)
```

```{r}
#saveRDS(total_stgm_hyst, "../results/total_stgm6.rds")
```

```{r}
total_stgm_hyst <- readRDS("../results/total_stgm6.rds")
```


```{r}
pvals_t_h <- summary(total_stgm_hyst)$coefficients[, "Pr(>|z|)"]
or_t_h <- exp(coef(total_stgm_hyst))
ste3 <- sqrt(diag(total_stgm_hyst$covar))
lci3 <- exp(coef(total_stgm_hyst) - 1.96 * ste3) # the lower bound of the 95% confidence interval (see https://en.wikipedia.org/wiki/1.96)
uci3 <- exp(coef(total_stgm_hyst) + 1.96 * ste3) # the upper bound of the 95% confidence interval (see https://en.wikipedia.org/wiki/1.96)
oddsratios3 <- cbind(round(coef(total_stgm_hyst)), round(lci3, digits = 4), round(or_t_h, digits = 4), round(uci3, digits = 4), pvals_t_h)
dataframe_t2 = as.data.frame(oddsratios3)
dataframe_t2$model_terms <- rownames(dataframe_t2)
rownames(dataframe_t2) <- NULL
colnames(dataframe_t2) <- c('est_t_h','lci_t_h', 'odds_t_h','uci_t_h', 'pvals_t_h', 'model_terms')
```
...
```{r}
#write.csv(dataframe_t2, "../results/total_stgm6_results.csv")
```

```{r}
mcmc.diagnostics(total_stgm_hyst)
```

Start: 7 August, 2025 at 6:26PM
End: 8 August, 2025 at 4 AM
```{r}
# goftest_t_h <- gof(total_stgm_hyst) 
# plot(goftest_t_h)
```

```{r}
#saveRDS(goftest_t_h, "../results/goftest_model6_t.rds")

goftest_t_h <- readRDS("../results/goftest_model6_t.rds")
```

```{r}
all_stats <- c("odegree", "idegree", "espartners", "distance", "model")
selected_stats_2 <- all_stats[2:5]

tiff(file = "../results/goftest_model6_t.tiff",
     width = 12, height = 3, units = "in", res = 100)
...
for (stat in selected_stats_2) {
  plot(goftest_t_h, which = stat, main = "Model 6", cex.lab = 1.5)
}
