...
5. Loading the edgelist of reproducible cultural goods trade, and making 24 network objects for 24 consecutive years following the steps,     
...
```{r}
#summary(repro_stgm)
#saveRDS(repro_stgm, "../results/reproducible_stgm2.rds")
